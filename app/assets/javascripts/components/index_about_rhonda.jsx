class IndexAboutRhonda extends React.Component {
  render() {
    return(
      <div>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-5 col-sm-6">
                        ...
                        <h2 className="section-heading">Who is Rhonda?</h2>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-5 col-lg-offset-1 col-sm-push-6  col-sm-6">
                        <hr className="section-heading-spacer"/>
                        <div className="clearfix"></div>
                        <h2 className="section-heading">What can Rhonda help you with?</h2>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-5 col-sm-6">
                        <hr className="section-heading-spacer"/>
                        <div className="clearfix"></div>
                        <h2 className="section-heading">Why Rhonda is the fucking shit</h2>
